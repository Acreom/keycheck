const app = {
  ...
  shortcuts: {
    ...
    "CmdOrCtrl+1": "Select the first tab",
    "CmdOrCtrl+2": "Select the second tab",
    "CmdOrCtrl+3": "Select the third tab",
    "CmdOrCtrl+4": "Select the fourth tab",
    "CmdOrCtrl+5": "Select the fifth tab",
    "CmdOrCtrl+6": "Select the sixth tab",
    "CmdOrCtrl+7": "Select the seventh tab",
    "CmdOrCtrl+8": "Select the eighth tab",
    "CmdOrCtrl+9": "Select the ninth tab",
